...
const Story = () => {
    return (
        <section className='story-container'>
            ...
            <div className="story-img mx-auto">
                <img src={tech} alt="" />
            </div>
